...
public class EndView extends BaseView{
	...
	public void drawSelf() {
		...
		try {
			...
			float textlong = paint.measureText("得分:"+String.valueOf(score));
			canvas.drawText("得分:"+String.valueOf(score), screen_width/2 - textlong/2, screen_height/2 - 100, paint);
		} catch (Exception err) {
			err.printStackTrace();
		} finally {
			if (canvas != null)
